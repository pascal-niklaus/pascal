...
#'
#' Given an ASReml object, this function displays the corresponding
#' ANOVA table, error strata, and variance components.
#'
...
#'
#' @param d.asr asreml object, returned from calling \code{asreml} or
#'     \code{asreml.nvc}
#' @param returnWald logical. If TRUE, \code{test.asreml} will return
#'     the table with the wald tests.
#'
#' @param silent logical. If TRUE, no output will be produced. This is
#'     useful when capturing the wald tests for further processing.
#'
